...
const Dashboard = () => {
  ...
  const dashboardCards = [
    {
      ...
      value: dasboardData.totalBookings || "0",
      icon: ChartLineIcon,
    },
    {
      title: "Total Revenue",
      value: currency + dasboardData.totalRevenue || "0",
      icon: CircleDollarSignIcon,
    },
    {
      title: "Active Shows",
      value: dasboardData.activeShows.length || "0",
      icon: PlayCircleIcon,
    },
    {
      title: "Total Users",
      value: dasboardData.totalUser || "0",
      icon: UserIcon,
    },
  ]
  ...
  return !loading? (
    ...
    <p className="mt-10 text-lg font font-medium">Active Shows</p>
    <div className="relative flex flex-wrap gap-6 mt-4 max-w-5xl">
      <BlurCircle top="100px" left="-10%" />
      {dasboardData.activeShows.map((show) => (
